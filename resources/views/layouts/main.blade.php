...
<head>
  ...
  <title>Indonesia Budget Center</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{asset('/img/logo_ibc.ico')}}" rel="icon">
  <link href="{{asset('/img/logo_ibc.png')}}" rel="apple-touch-icon">
...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <!-- Uncomment the line below if you also wish to use an image logo -->
         <img src="{{asset('img/logo_ibc.png')}}" alt=""> 
        <h4 class="sitename">Indonesia Budget Center (IBC)</h4>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#features">Laporan Anggaran</a></li>
          <li><a href="#gallery">Analisis</a></li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#">Terbitan(buku)</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      <img src="{{asset('img/ibc4.jpeg')}}" alt="" class="hero-bg">
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
            <h1>Mewujudkan Keadilan dan Kedaulatan Anggaran untuk <span>Rakyat</span></h1>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/gallery-4.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="assetimg/gallery/gallery-4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            ...
            <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
              <h3><span>Forum</span><strong>Diskusi</strong></h3>
              <p>
